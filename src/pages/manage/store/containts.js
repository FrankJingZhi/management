 ...
 * @lastTime: 2019-05-08 13:05:09
 */
export const GET_TABLE_INFO = 'manage/GET_TABLE_INFO';
export const CHANGE_SELECTED_ROW_KEYS = 'manage/CHANGE_SELECTED_ROW_KEYS';
export const CHANGE_SELECTED_ROWS = 'manage/CHANGE_SELECTED_ROWS';
export const GET_COLUMNS_INFO = 'manage/GET_COLUMNS_INFO';
export const SHOW_ADD_HANDLE_CLICK = 'manage/SHOW_ADD_HANDLE_CLICK';

...
import ExamBindInfo from './components/examManage/examBindInfo'; //试卷绑定组件
...
import QuesBind from './components/questionManage/quesBind'; //编辑题目管理组件
			...
			<Layout style={{ padding: '24px 0', background: '#fff' }}>
				...
				<Content style={{ padding: '0 24px', minHeight: 280 }}>
					...
					<Switch>
						...
						<Route path={`${match.url}/userManage/examBindInfo`} exact component={ExamBindInfo} />
						...
						<Route path={`${match.url}/questionManage/quesBind`} exact component={QuesBind} />
					</Switch>
				</Content>
			</Layout>
		);
